  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 via-blue-50 to-white p-6">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-[#FAC54D] hover:bg-yellow-200 cursor-pointer text-black font-semibold py-2 rounded-lg transition"
        >
          Login
        </button>
        <span className='flex justify-center text-black w-full items-center gap-2'>
        I haven't an Account,
        <button className='text-blue-800 cursor-pointer' onClick={handleRegistrationRequest}>Registration</button>
      </span>
      </form>
