    ...
    <>
      <ClickAwayListener onClickAway={() => onClose?.()}>
        <motion.div
          ...
          className="absolute md:top-24 lg:top-24 right-3 lg:right-4 gap-2 flex flex-col bg-zinc-300 text-blue-900 shadow-xl rounded-lg w-[90%] sm:w-[400px] max-w-full p-4 z-50 overflow-hidden"
        >
